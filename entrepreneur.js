// Entrepreneur registration page — fully self-contained (fields, rendering,
...
const FIELDS = [
    ...
    { name: "businessName", label: "Business / company name", type: "text" },
    { name: "businessType", label: "Business type", type: "text" },
    { name: "industry", label: "Industry / sector", type: "text" },
    { name: "businessAddress", label: "Business address", type: "text", fullWidth: true },
];
...
document.getElementById("reg-form").addEventListener("submit", function (e) {
    ...
    // fetch("/api/register/entrepreneur", {
    //   method: "POST",
